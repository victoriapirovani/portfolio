$(function () {
  ...
  $('.contact-form').on('submit', function () {
    ...
    var msg = 'The following fields should be filled:',
      successMessage =
        'Your email is very important to us. One of our representatives will contact you at first chance.',
      error = 0,
      pattern = new RegExp(
    ...
    if ($.trim($('.contact-form textarea[name="message"]').val()) === '') {
      error = 1
    ...
    if (error) {
      ...
      var url = 'send_mail.php',
        ...
        subject = $this.find('input[name="subject"]').length
